...
def log_score_planet(
    ...
    return (
        ...
        - _w(features.missing_transit_fraction_score, 0.70)
        - _w(features.transit_asymmetry_score, 0.50)
        - _w(features.extra_event_score, 0.60)
...
def log_score_instrumental(
    ...
    return (
        ...
        + _w(features.missing_transit_fraction_score, 0.60)
        + _w(features.transit_asymmetry_score, 0.50)
        + _w(features.extra_event_score, 0.50)
