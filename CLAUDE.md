...
class, distance, storage, explicit search status, prior-search
...
unchanged canonical functions. Clean 10/10 exact-tree gates with 3,214 tests,
all PR #324 CI events, squash merge `12ec767`, merged-main CI, synchronization,
and installed merged-main probes pass. Current command-contract evidence is
`artifacts/manifests/hunter_live_acceptance_v14.json`; v13 preserves the live
new/follow-up scientific workflows.
...
create-through-execution workflows pass in
`artifacts/manifests/hunter_live_acceptance_v13.json`. PR #322 passed all
branch, pull-request, ready-event, and merged-main CI runs, squash-merged as
`6b8c78e`, and the clean synchronized merge commit passed 10/10 local gates
with 3,212 tests.
...
gates, both final PR #319 CI runs, squash merge, and clean merged-main
verification pass. The older version narrative below is historical context,
