...
- 109 top-level test files, 2,220 default tests passing
...
Result: ruff passed, mypy passed, pytest passed with 2,220 passed, 2 deselected, and 2 Lightkurve package warnings.
