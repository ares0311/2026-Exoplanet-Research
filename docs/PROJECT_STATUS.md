...
- 108 top-level test files, 2,170 default tests passing
...
Result: ruff passed, mypy passed, pytest passed with 2,170 passed, 2 deselected, and 2 Lightkurve package warnings.
