...
Test baseline: 2,943 default tests passing; 2 `integration_live` tests excluded by
the configured marker expression (2026-07-17; 6×6 gate: 27.2s, 10/10 gates
...
Version note: 0.2.87 is the current patch level. 0.2.8 fixed QLP stitch
