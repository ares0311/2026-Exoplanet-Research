...
Test baseline: 2,973 default tests passing; 2 `integration_live` tests excluded by
the configured marker expression (2026-07-17; 6×6 gate: 23.2s, 10/10 gates
...
Version note: 0.2.93 is the current patch level. 0.2.8 fixed QLP stitch
