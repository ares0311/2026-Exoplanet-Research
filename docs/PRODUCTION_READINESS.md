...
Test baseline: 2,914 default tests passing; 2 `integration_live` tests excluded by
the configured marker expression (2026-07-16; 6×6 gate: 25.1s, 10/10 gates
...
Version note: 0.2.85 is the current patch level. 0.2.8 fixed QLP stitch
