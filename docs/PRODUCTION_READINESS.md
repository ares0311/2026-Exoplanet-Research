...
Test baseline: 2,218 default tests passing, 2 integration_live deselected
...
- **Current data gate**: Kepler and TESS split validators passed; `data/tess_cnn_splits` has train/val/test = 1,477 / 318 / 315; the first fine-tuned TESS checkpoint is rejected and no CNN artifact is approved for promotion; Path A inventory is too small for candidate-12 training
...
| 2,218 default tests, ruff clean, mypy clean | ✅ |
