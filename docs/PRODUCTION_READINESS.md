...
Test baseline: 3,020 default tests passing; 2 `integration_live` tests excluded by
the configured marker expression (2026-07-18; 6×6 gate: 29.1s, 10/10 gates
...
Version note: 0.2.98 is the current patch level. 0.2.8 fixed QLP stitch
