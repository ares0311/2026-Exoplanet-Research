...
| `checkpoints/cnn_kepler_pretrain/` | Local pretrained checkpoint | Ignored | 2026-06-18 local training: `best.pt` SHA-256 `65c49aaa8668fc56b5a466469937bb62beb0acf1680d985c4e570df98d0b7e11`; best epoch 20; best val loss 0.3840; best val AUC 0.9215; final epoch 35 val AUC 0.9113; produced before GPU-aware trainer patch | Use as transfer-learning source for TESS fine-tuning unless intentionally regenerating after code/config change |
