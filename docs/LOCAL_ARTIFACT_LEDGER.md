...
| `data/tess_k2_overlap_snippets.jsonl` | **NOT YET BUILT** — authorized 2026-06-22 | Ignored | K2 EPIC KOI confirmed planets/FPs with TESS re-observations folded at K2 ephemerides; analogous to `data/tess_kepler_overlap_snippets.jsonl`; expected to yield 500–1,500 new labeled TESS-domain snippets; build script: `Skills/fetch_tess_k2_overlap_snippets.py` (must be written) | [AGENT] write fetcher analogous to Kepler overlap fetcher; [HUMAN] run multi-hour MAST fetch after script is on main |
