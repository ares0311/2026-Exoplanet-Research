...
| `data/tess_cnn_splits/` | Local validated split | Ignored | 2026-06-18 validator PASS; total examples=2,110; train/val/test = 1,477 / 318 / 315; train labels negative=766 positive=711; val negative=166 positive=152; test negative=163 positive=152 | Fine-tune from the MPS Kepler pretrain checkpoint |
| `checkpoints/cnn_kepler_pretrain/` | Local pretrained MPS checkpoint | Ignored | 2026-06-18 local training: startup banner `device=mps`; `best.pt` SHA-256 `c782d7af61171b3f58447f7a49343c86618c447292a71bd28d540807835787c7`; best epoch 19; best val loss 0.3905; best val AUC 0.9186; final epoch 34 val AUC 0.9123 | Use as transfer-learning source for TESS fine-tuning unless intentionally regenerating after code/config change |
| `checkpoints/cnn_tess_finetuned/` | Pending | Ignored | No approved checkpoint | Fine-tune from the MPS Kepler pretrain checkpoint using validated TESS splits; run production gate evaluator |
