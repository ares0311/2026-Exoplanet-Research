...
| 🟡 | **First real discovery scan** | Run006 produced real QLP evidence and run008 targeted follow-up reproduced both filtered candidates; version 0.2.10 candidate packets expose diagnostics/provenance/missing reasons and retry transient MAST disconnects during regeneration. The active gate remains candidate-specific false-positive diagnostics before any external action or CNN work. | `docs/DISCOVERY_RUNBOOK.md`, `docs/PRODUCTION_READINESS.md`, `docs/LOCAL_ARTIFACT_LEDGER.md` |
