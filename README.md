...
| 🟡 | **Production CNN checkpoint** | The first seed-42 candidate was trained and rejected after held-out AUC/F1 and calibration gates failed; improve generalization, retrain without tuning on the opened test partition, and promote only a passing candidate. | Rejection metrics and hash: `docs/CNN_SPEC.md`; authoritative blocker: `docs/PRODUCTION_READINESS.md` |
