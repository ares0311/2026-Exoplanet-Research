...
| 🟡 | **First real discovery scan** | Run006 produced real QLP evidence and run008 targeted follow-up reproduced both filtered candidates under version 0.2.8; the active gate is now candidate-specific false-positive diagnostics before any external action or CNN work. | `docs/DISCOVERY_RUNBOOK.md`, `docs/PRODUCTION_READINESS.md`, `docs/LOCAL_ARTIFACT_LEDGER.md` |
