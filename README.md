...
| 🟡 | **Production CNN checkpoint** | C1-C19 were rejected; the active plan is now the source-contract-first dataset/model workflow in `docs/exoplanet_exomoon_dataset_handoff.md`, with verified public sources, leakage-safe manifests, bounded local runs, and promotion only after held-out gates pass. | Root cause, rejection metrics, and handoff: `docs/CNN_SPEC.md`, `docs/CNN_PRODUCTION_RUNBOOK.md`, `docs/exoplanet_exomoon_dataset_handoff.md`; authoritative blocker: `docs/PRODUCTION_READINESS.md` |
