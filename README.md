...
| 🟡 | **Production CNN checkpoint** | C1-C19 were rejected, but the T1-1 source-contract path produced a master Kepler corpus and a passing checkpoint: `checkpoints/cnn_t1_1_kepler_master/best.pt` reached raw test AUC 0.9572, calibrated F1 0.8347, Brier 0.0580, ECE 0.0142. Remaining work is explicit human promotion approval plus model card/registry/reproducibility metadata before committing selected artifacts under `models/`. | `metadata/t1_1_kepler_training_manifest.jsonl`, `metadata/t1_1_kepler_dr24_expansion_manifest.jsonl`, `docs/CNN_SPEC.md`, `docs/CNN_PRODUCTION_RUNBOOK.md`, `docs/exoplanet_exomoon_dataset_handoff.md`, `docs/PRODUCTION_READINESS.md` |
