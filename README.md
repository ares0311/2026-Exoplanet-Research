...
The repository also contains 116 standalone `Skills/` utilities with dedicated tests. Current local validation passes 2320 default tests with the two live integration tests deselected; see `docs/PROJECT_STATUS.md` for the latest validation note.
...
│   └── SKILLS_GUIDE.md          # User reference and inventory for 116 Skills scripts
...
| Skills utilities | 116 scripts with dedicated tests |
| **Current default suite** | **2320 passed, 2 live tests deselected** |
...
| ✅ | **Skills guide** | `docs/SKILLS_GUIDE.md` — workflow reference and current inventory for all 116 Skills |
